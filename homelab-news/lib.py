...
NODE_EXPORTER_INSTANCE = os.getenv("NODE_EXPORTER_INSTANCE", "traefik.lan:9100")
KOPIA_URL        = os.getenv("KOPIA_URL", "https://kopia-webui:5151")
KOPIA_USER       = os.getenv("KOPIA_USER", "admin")
KOPIA_PASS       = os.getenv("KOPIA_PASS", "")
BESZEL_URL       = os.getenv("BESZEL_URL", "http://beszel.lan:8090")
...
PVE_SSH_HOST     = os.getenv("PVE_SSH_HOST",     "root@pve.lan")
TRUENAS_SSH_HOST = os.getenv("TRUENAS_SSH_HOST", "truenas_admin@smsf.lan")
ADGUARD_URLS: list[tuple[str, str]] = [
    (os.getenv("ADGUARD_PRIMARY_URL", "http://dns.lan"),      "Primary DNS"),
    (os.getenv("ADGUARD_KIDS_URL",    "http://dns.kids.lan"),  "Kids DNS"),
]
PLEX_LXC_ID         = os.getenv("PLEX_LXC_ID",         "104")
HOMEASSISTANT_URL   = os.getenv("HOMEASSISTANT_URL",   "http://homeassistant.iot.lan:8123")
HOMEASSISTANT_TOKEN = os.getenv("HOMEASSISTANT_TOKEN", "")
BESZEL_SSH_HOST     = os.getenv("BESZEL_SSH_HOST",     "nat@beszel.lan")
