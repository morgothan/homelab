...
EVENT_LEDGER_FILE = os.path.join(DATA_DIR, "events.json")
CONTAINER_STATE_FILE = os.path.join(DATA_DIR, "container_state.json")
UPDATE_DETECTION_STATE_FILE = os.path.join(DATA_DIR, "update_detection_state.json")
...
SPARK2_SSH_HOST = os.getenv("SPARK2_SSH_HOST", "")
